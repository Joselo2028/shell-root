(self["webpackChunkshell_root"] = self["webpackChunkshell_root"] || []).push([[691],{
...
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ 2083);
...
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/platform-browser */ 1228);
...
function firstValueFrom(source) {
  return new Promise((resolve, reject) => {
    source.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.first)()).subscribe({
...
class ActivatedRoute {
  ...
  constructor(urlSubject, paramsSubject, queryParamsSubject, fragmentSubject, dataSubject, outlet, component, futureSnapshot) {
    ...
    this.title = this.dataSubject?.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(d => d[RouteTitleKey])) ?? (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(undefined);
    this.url = urlSubject;
...
const ROUTER_OUTLET_DATA = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode ? 'RouterOutlet data' : '');
...
const INPUT_BINDER = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode ? 'Router Input Binder' : '');
let RoutedComponentInputBinder = /*#__PURE__*/(() => {
  class RoutedComponentInputBinder {
    ...
    subscribeToRouteData(outlet) {
      ...
      const dataSubscription = (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.combineLatest)([activatedRoute.queryParams, activatedRoute.params, activatedRoute.data]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(([queryParams, params, data], index) => {
        data = {
          ...queryParams,
          ...params,
          ...data
...
function isEmptyError(e) {
  return e instanceof rxjs__WEBPACK_IMPORTED_MODULE_3__.EmptyError || e?.name === 'EmptyError';
}
const INITIAL_VALUE = /* @__PURE__ */Symbol('INITIAL_VALUE');
function prioritizedGuardValue() {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(obs => {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.combineLatest)(obs.map(o => o.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.startWith)(INITIAL_VALUE)))).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(results => {
...
function abortSignalToObservable(signal) {
  if (signal.aborted) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(undefined).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.take)(1));
  }
...
function takeUntilAbort(signal) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.takeUntil)(abortSignalToObservable(signal));
}
function checkGuards(forwardEvent) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(t => {
    ...
    return runCanDeactivateChecks(canDeactivateChecks, targetSnapshot, currentSnapshot).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(canDeactivate => {
      return canDeactivate && isBoolean(canDeactivate) ? runCanActivateChecks(targetSnapshot, canActivateChecks, forwardEvent) : (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(canDeactivate);
...
function runCanDeactivateChecks(checks, futureRSS, currRSS) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.from)(checks).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(check => runCanDeactivate(check.component, check.route, currRSS, futureRSS)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.first)(result => {
    return result !== true;
  }, true));
}
function runCanActivateChecks(futureSnapshot, checks, forwardEvent) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.from)(checks).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.concatMap)(check => {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.concat)(fireChildActivationStart(check.route.parent, forwardEvent), fireActivationStart(check.route, forwardEvent), runCanActivateChild(futureSnapshot, check.path), runCanActivate(futureSnapshot, check.route));
...
function redirectIfUrlTree(urlSerializer) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.pipe)((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(result => {
...
class ApplyRedirects {
  ...
  lineralizeSegments(route, urlTree) {
    return (0,C_Users_USUARIO_latinka_mfe_shell_root_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      let res = [];
      let c = urlTree.root;
      while (true) {
...
function matchWithChecks(segmentGroup, route, segments, injector, urlSerializer, createSnapshot, abortSignal) {
  ...
  return runCanMatchGuards(injector, route, segments, urlSerializer, currentSnapshot, abortSignal).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(v => v === true ? result : {
    ...noMatch
  }));
}
...
function _recognize$() {
  _recognize$ = (0,C_Users_USUARIO_latinka_mfe_shell_root_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (injector, configLoader, rootComponentType, config, urlTree, urlSerializer, paramsInheritanceStrategy = 'emptyOnly', abortSignal) {
...
function recognize(injector, configLoader, rootComponentType, config, serializer, paramsInheritanceStrategy, abortSignal) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(/*#__PURE__*/function () {
    var _ref = (0,C_Users_USUARIO_latinka_mfe_shell_root_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (t) {
      const {
...
function resolveData(paramsInheritanceStrategy) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(t => {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.from)(routesNeedingDataUpdates).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.concatMap)(route => {
    ...
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(() => routesProcessed++), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.takeLast)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(_ => routesProcessed === routesNeedingDataUpdates.size ? (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(t) : rxjs__WEBPACK_IMPORTED_MODULE_3__.EMPTY));
  });
}
...
function runResolve(futureARS, futureRSS, paramsInheritanceStrategy) {
  ...
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.defer)(() => {
    ...
    return resolveNode(resolve, futureARS, futureRSS).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(resolvedData => {
...
function resolveNode(resolve, futureARS, futureRSS) {
  ...
  const data = {};
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.from)(keys).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.mergeMap)(key => getResolver(resolve[key], futureARS, futureRSS).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.first)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(value => {
    if (value instanceof RedirectCommand) {
      throw redirectingNavigationError(new DefaultUrlSerializer(), value);
    }
    data[key] = value;
  }))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.takeLast)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(() => data), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.catchError)(e => isEmptyError(e) ? rxjs__WEBPACK_IMPORTED_MODULE_3__.EMPTY : (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.throwError)(e)));
}
...
function switchTap(next) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(v => {
    ...
    if (nextResult) {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.from)(nextResult).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(() => v));
    }
...
let DefaultTitleStrategy = /*#__PURE__*/(() => {
  class DefaultTitleStrategy extends TitleStrategy {
    ...
    static ɵfac = function DefaultTitleStrategy_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || DefaultTitleStrategy)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_5__.Title));
    };
    static ɵprov = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({
...
const ROUTER_CONFIGURATION = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'router config' : '', {
  factory: () => ({})
});
const ROUTES = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode ? 'ROUTES' : '');
  ...
  class RouterConfigLoader {
    ...
    loadComponent(injector, route) {
      ...
      return (0,C_Users_USUARIO_latinka_mfe_shell_root_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        ...
        const loader = (0,C_Users_USUARIO_latinka_mfe_shell_root_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
          try {
...
function _loadChildren() {
  _loadChildren = (0,C_Users_USUARIO_latinka_mfe_shell_root_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (route, compiler, parentInjector, onLoadEndListener) {
...
function _maybeResolveResources() {
  _maybeResolveResources = (0,C_Users_USUARIO_latinka_mfe_shell_root_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (value) {
...
const CREATE_VIEW_TRANSITION = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode ? 'view transition helper' : '');
const VIEW_TRANSITION_OPTIONS = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode ? 'view transition options' : '');
...
const noop = () => {};
const NAVIGATION_ERROR_HANDLER = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'navigation error handler' : '');
let NavigationTransitions = /*#__PURE__*/(() => {
  class NavigationTransitions {
    ...
    events = new rxjs__WEBPACK_IMPORTED_MODULE_3__.Subject();
    transitionAbortWithErrorSubject = new rxjs__WEBPACK_IMPORTED_MODULE_3__.Subject();
    ...
    transitions;
    afterPreactivation = () => (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(void 0);
    ...
    setupNavigations(router) {
      this.transitions = new rxjs__WEBPACK_IMPORTED_MODULE_3__.BehaviorSubject(null);
      return this.transitions.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(t => t !== null), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(overallTransitionState => {
        let completedOrAborted = false;
        const abortController = new AbortController();
        const shouldContinueNavigation = () => {
          return !completedOrAborted && this.currentTransition?.id === overallTransitionState.id;
        };
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(overallTransitionState).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(t => {
          ...
          if (this.urlHandlingStrategy.shouldProcessUrl(t.rawUrl)) {
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(t).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(t => {
              this.events.next(new NavigationStart(t.id, this.urlSerializer.serialize(t.extractedUrl), t.source, t.restoredState));
              if (t.id !== this.navigationId) {
                return rxjs__WEBPACK_IMPORTED_MODULE_3__.EMPTY;
              }
              return Promise.resolve(t);
            }), recognize(this.environmentInjector, this.configLoader, this.rootComponentType, router.config, this.urlSerializer, this.paramsInheritanceStrategy, abortController.signal), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(t => {
            ...
            }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(value => (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.from)(overallTransitionState.routesRecognizeHandler.deferredHandle ?? (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(void 0)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(() => value))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(() => {
        ...
        }), checkGuards(evt => this.events.next(evt)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(t => {
          ...
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(t).pipe(resolveData(this.paramsInheritanceStrategy), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)({
            next: () => {
              dataResolved = true;
          ...
          return loaders.length === 0 ? (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(t) : (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.from)(Promise.all(loaders).then(() => t));
          ...
          return viewTransitionStarted ? (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.from)(viewTransitionStarted).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.map)(() => overallTransitionState)) : (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(overallTransitionState);
        }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(t => {
          ...
          return deferred ? (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.from)(deferred.then(() => t)) : (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(t);
          ...
          t.resolve(true);
        }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.takeUntil)(abortSignalToObservable(abortController.signal).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(() => !completedOrAborted && !overallTransitionState.targetRouterState), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(() => {
        ...
        }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.takeUntil)(this.transitionAbortWithErrorSubject.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(err => {
          throw err;
...
const ROUTE_INJECTOR_CLEANUP = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'RouteInjectorCleanup' : '');
...
function afterNextNavigation(router, action) {
  ...
  }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.filter)(result => result !== 2), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.take)(1)).subscribe(() => {
    action();
  });
}
let Router = /*#__PURE__*/(() => {
  class Router {
    ...
    _events = new rxjs__WEBPACK_IMPORTED_MODULE_3__.Subject();
    get events() {
      return this._events;
    }
    get routerState() {
    ...
    eventsSubscription = new rxjs__WEBPACK_IMPORTED_MODULE_3__.Subscription();
...
let ReactiveRouterState = /*#__PURE__*/(() => {
...
let RouterLinkActive = /*#__PURE__*/(() => {
  class RouterLinkActive {
    ...
    ngAfterContentInit() {
      (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.of)(this.links.changes, (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.of)(null)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.mergeAll)()).subscribe(_ => {
        this.update();
    ...
    subscribeToEachLinkOnChanges() {
      ...
      this.linkInputChangesSubscription = (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.from)(allLinkChanges).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.mergeAll)()).subscribe(link => {
...
let PreloadAllModules = /*#__PURE__*/(() => {
  class PreloadAllModules {
    preload(route, fn) {
      return fn().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.catchError)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.of)(null)));
    }
...
let RouterPreloader = /*#__PURE__*/(() => {
  class RouterPreloader {
    ...
    setUpPreloading() {
      this.subscription = this.router.events.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.filter)(e => e instanceof _router_chunk_mjs__WEBPACK_IMPORTED_MODULE_3__.NavigationEnd), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.concatMap)(() => this.preload())).subscribe(() => {});
    }
    preload() {
    ...
    processRoutes(injector, routes) {
      ...
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.from)(res).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.mergeAll)());
    }
    preloadConfig(injector, route) {
      return this.preloadingStrategy.preload(route, () => {
        ...
        if (route.loadChildren && route.canLoad === undefined) {
          loadedChildren$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.from)(this.loader.loadChildren(injector, route));
        } else {
          loadedChildren$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.of)(null);
        }
        const recursiveLoadChildren$ = loadedChildren$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.mergeMap)(config => {
          if (config === null) {
        ...
        if (route.loadComponent && !route._loadedComponent) {
          ...
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.from)([recursiveLoadChildren$, loadComponent$]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.mergeAll)());
        } else {
...
const ROUTER_SCROLLER = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode ? 'Router Scroller' : '');
let RouterScroller = /*#__PURE__*/(() => {
  class RouterScroller {
    ...
    scheduleScrollEvent(routerEvent, anchor) {
      ...
      this.zone.runOutsideAngular(/*#__PURE__*/(0,C_Users_USUARIO_latinka_mfe_shell_root_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  class NavigationStateManager extends _router_chunk_mjs__WEBPACK_IMPORTED_MODULE_3__.StateManager {
      ...
      return (0,C_Users_USUARIO_latinka_mfe_shell_root_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        ...
        if (e instanceof _router_chunk_mjs__WEBPACK_IMPORTED_MODULE_3__.NavigationStart) {
          ...
          transition.routesRecognizeHandler.deferredHandle = new Promise(/*#__PURE__*/function () {
            var _ref2 = (0,C_Users_USUARIO_latinka_mfe_shell_root_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve) {
          ...
          transition.beforeActivateHandler.deferredHandle = new Promise(/*#__PURE__*/function () {
            var _ref3 = (0,C_Users_USUARIO_latinka_mfe_shell_root_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve) {
    ...
    handleNavigate(event) {
      ...
      if (this.deferredCommitSupported(event)) {
        ...
        this.currentNavigation.commitUrl = /*#__PURE__*/(0,C_Users_USUARIO_latinka_mfe_shell_root_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
const ROUTER_IS_PROVIDED = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode !== 'undefined' && ngDevMode ? 'Router is provided' : '', {
  factory: () => false
});
...
const BOOTSTRAP_DONE = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'bootstrap done indicator' : '', {
  factory: () => {
    return new rxjs__WEBPACK_IMPORTED_MODULE_4__.Subject();
  }
});
const INITIAL_NAVIGATION = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'initial navigation' : '', {
  factory: () => 1
});
...
const ROUTER_PRELOADER = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'router preloader' : '');
...
const ROUTER_FORROOT_GUARD = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'router duplicate forRoot guard' : '');
...
const ROUTER_INITIALIZER = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken(typeof ngDevMode === 'undefined' || ngDevMode ? 'Router Initializer' : '');
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 1913);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common */ 2083);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs */ 4866);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs/operators */ 2778);
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/platform-browser */ 1228);
/**
 * @license Angular v21.2.14
 * (c) 2010-2026 Google LLC. https://angular.dev/
 * License: MIT
